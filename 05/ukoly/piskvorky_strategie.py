...
while True:
    ...
    if "-oo" in herni_pole:
        herni_pole = tah_pocitace_strategie_vlevo(herni_pole, 'o', "-oo")
    elif "oo-" in herni_pole:
        herni_pole = tah_pocitace_strategie_vpravo(herni_pole, "o", "oo-")
    elif "-xx" in herni_pole:
        herni_pole = tah_pocitace_strategie_vlevo(herni_pole, 'o', "-xx")
    elif "-o-" in herni_pole:
        herni_pole = tah_pocitace_strategie_vlevo(herni_pole, 'o', "-o-")
    elif "xx-" in herni_pole:
        herni_pole = tah_pocitace_strategie_vpravo(herni_pole, "o", "xx-")
    elif "-o" in herni_pole:
        herni_pole = tah_pocitace_strategie_vlevo(herni_pole, 'o', "-o")
    elif "-x" in herni_pole:
        herni_pole = tah_pocitace_strategie_vlevo(herni_pole, "o", "-x")
    else:
